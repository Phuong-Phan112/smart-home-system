...
# state_lock verhindert, dass MQTT (schreiben) und REST API (Lesen) gleichzeitig auf state zugreifen und dadurch inkonsistente Daten entstehen
# die Kopie sorgt dafür, dass der Lock nur kurz gehalten wird
