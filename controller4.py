...
state_lock = threading.Lock() # sicher stellen, dass nie 2 Threads gleichzeitig
...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .grid {
      display: grid;
      grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));  #passt sich automatic am Bildschirm Breite
      gap: 1rem;
      max-width: 800px;
    ...
    .card {
      background: white;
      border-radius: 14px;   #abgrunde Ecke
      padding: 1.25rem;
      box-shadow: 0 2px 8px rgba(0,0,0,0.07);  #Schatten
      display: flex;
